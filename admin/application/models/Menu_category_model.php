...
Class Menu_category_model extends MY_Model {
    ...
    public function putCartTopData($status='',$id='')
    {
      ...
      $value_cat= array('menu_cat_status' => $status);
    ...
    public function getMenuCategoryWise()
    {

        $this->db->select('cart_category.cat_id,cart_category.cat_name,cart_category.cat_icon');
