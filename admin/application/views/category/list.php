          ...
          <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header">
                  <a class="btn bg-olive" href="<?php echo base_url() ?>category/create"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Category/cat_list'); ?>',
        "type": "POST",
        },
        });
    });
