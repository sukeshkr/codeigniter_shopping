        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
             <label class="form-control-label" for="inputBasicFirstName">Category Root</label>  
    
            <select class="form-control selectpicker" name="parent" data-live-search="true">
                <option value="">- Root level -</option>
                <?php foreach ($category as $row) { ?>
                 <option value="<?= $row['cat_id'];?>" <?php echo set_select('parent',$row['cat_id'], False); ?>><?= $row['cat_name'];?></option>
                 <?php } ?>
            </select>
            </div>
