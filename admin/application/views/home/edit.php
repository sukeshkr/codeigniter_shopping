...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
     <form name="myform" role="form" action="<?= CUSTOM_BASE_URL . 'home_banner/update' ?>" method="post" enctype="multipart/form-data" onSubmit="return checkForm()">
            <!-- text input -->
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Change image</label>
                     <a class="btn btn-block btn-default cropModal" data-toggle="modal" data-target="#cropModall"> <img  src="<?= CUSTOM_BASE_URL . 'uploads/'.$ci_name.'/crop/'.$row['crop_image']; ?>"  class="img-responsive" id="previews"></a>
