          ...
          <div class="row">
            ...
            <div class="col-md-4">
             <div class="form-group">   
                  ...
                  <input type="text" class="form-control" name="latitude" maxlength="70"  value="<?php echo set_value('latitude') ?>">
            ...
            <div class="col-md-4">
             <div class="form-group">   
                  ...
                  <input type="text" class="form-control" name="longitude" maxlength="70"  value="<?php echo set_value('longitude') ?>">
