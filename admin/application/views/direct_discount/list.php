...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        "ajax": {
        "url": '<?php echo site_url('Direct_discount/direct_list'); ?>',
        "type": "POST",
        },
        });
    });
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#view-modal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo site_url('Direct_discount/view'); ?>',
                data: 'rowid=' + rowid,
...
<script type="text/javascript">
    ...
    $(document).ready(function () {//delete_casestudy modal when edit button click
        $('#delModal').on('show.bs.modal', function (e) 
        {
            ...
            $.ajax({
                type: 'post',
                url: '<?= CUSTOM_BASE_URL . 'Direct_discount/delete' ?>', //Here you will fetch records 
